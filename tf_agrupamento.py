...
Original file is located at
    https://colab.research.google.com/drive/1t8vr6ponzy4K28lo3dWS3XSJL8s_Of8g
"""
...
#Matriz com os filmes assisitidos
#Variavel
...
#Definindo o número de grupos (cluster)
num_cluster = 2
...
for i, cluster in enumerate(grupos_indice):
  ...
  for i in range(len(filmes_assistidos)):
    ...
    print(f"Usuário [i1] assistiu aos filmes: {assistidos}")
...
def recomendar_filmes(filmes, filmes_assistidos, grupos_indice):
  ...
  #Encontrar o grupo de usuário com base no vetor dos filmes
  ...
  #Filmes assistidos pelo usuários no mesmo grupo
...
# Vetor de filmes assistidos (por exemplo, assistiu ao filmes 1 e 3)
